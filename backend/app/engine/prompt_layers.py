...
def build_ltx_video_canon_block(*, lip_sync: bool) -> str:
    ...
    lines = [
        ...
        "- smooth dynamic nightclub realism, controlled musical movement, beat-shaped but readable motion",
        "- stable anatomy-safe choreography with elegant club-energy, not frantic chaos",
