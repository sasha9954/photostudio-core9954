...
export function buildMockSplitJson(durationSec = 24) {
  ...
  const scenes = [
    { scene_id: "seg_01", index: 1, start_sec: 0, end_sec: Math.min(3.6, total), route: "ia2v", energy: "soft", quality: "good", boundary_reason: "end_of_vocal_phrase", transition_out: "soft_cut_after_tail", drama_hint: "Вступление", short_note: "Задаём эмоциональный тон." },
    { scene_id: "seg_02", index: 2, start_sec: Math.min(3.6, total), end_sec: Math.min(8.2, total), route: "i2v", energy: "mid", quality: "check", boundary_reason: "music_accent", transition_out: "cut_on_music_accent", drama_hint: "Первый конфликт", short_note: "Сюжетная перебивка." },
