  ...
  return matchSegments
    .map((segment, index) => {
      ...
      return normalizeVideoBlock({
        ...
        visualFamily: selectedCandidate.visualFamily,
        visual_family: selectedCandidate.visual_family,
        sourceUsageKey: selectedCandidate.sourceUsageKey,
        source_usage_key: selectedCandidate.source_usage_key,
        cleanCutStatus: selectedCandidate.cleanCutStatus,
        clean_cut_status: selectedCandidate.clean_cut_status,
        eventAnchor: selectedCandidate.eventAnchor,
        event_anchor: selectedCandidate.event_anchor,
        selectedIsReused: selectedCandidate.selectedIsReused,
        selected_is_reused: selectedCandidate.selected_is_reused,
        selectedReuseReason: selectedCandidate.selectedReuseReason,
        selected_reuse_reason: selectedCandidate.selected_reuse_reason,
      }, sourceVideoUrl);
    })
    .filter(Boolean);
}
