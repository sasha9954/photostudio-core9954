...
export default function AiScenarioDirectorV2Node({ id, data }) {
  ...
  useEffect(() => {
    ...
    if (finalReady || finalizeDone) {
      nextStages.final = {
        ...nextStages.final,
        status: finalizeDone ? "confirmed" : "ready",
        confirmed: finalizeDone,
        stale: false,
        error: "",
